...
int main()
{
...

  {
    ...
    f_type f_cast_a = static_cast<f_type>(f); // expected-error{{address of overloaded function}} expected-error{{illegal initializer}}
    f_type f_cast_b = (f_type)(f); // expected-error{{address of overloaded function}}
  }
}
